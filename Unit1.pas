...
///////////////Quantidade a ressuprir na situaçao Atual/////////////////
...
////////////////Fim Quantidade a ressuprir na situaçao Atual///////////
...
if edit11.Text='' then
    begin
Showmessage('Digite o Valor do Custo Unitário de Aquisição!');
edit11.SetFocus;
   end
else
    begin
if edit12.text='' then
    begin
Showmessage('Digite o Valor do Preço Unitário do Item!');
edit12.SetFocus;
   end
else
begin
...
if edit5.Text='' then
  begin
ShowMessage('Digite o Quantidade do Estoque de Segurança');
edit5.SetFocus;
     end
else
  begin
...
begin
Label38.Caption:='Não é Preciso Reduzir'
end
else
begin
Label38.Caption:=''
...
begin
Label39.Caption:='Não é Preciso Reduzir'
end
else
begin
Label39.Caption:=''
...
begin
ShellAbout(Handle, 'SIADRM Calculos Logisticos 1.0 Versão Beta', 'Desenvolvido e distribuído por J' +
          'osé Dantas.'#13'Este programa é freeware. Contato: j' +
